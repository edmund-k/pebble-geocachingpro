...
Pebble.addEventListener("showConfiguration",
  function() {
    ...
    var htmlData = "<html><head></head><body>Onboard text<br><a href='" + uri + "'>Offboard settings page</a><br></body></html>"
    var encodedData = encode64(htmlData);
    uri = "data:text/html;charset=utf-8;base64," + encodedData;
    console.log("### Configuration url: " + uri);
    Pebble.openURL(uri);
    //var decodedData = decode64(encodedData);
